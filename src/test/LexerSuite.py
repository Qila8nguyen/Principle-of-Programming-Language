...
class LexerSuite(unittest.TestCase):
    ...
    def test_lexer115(self):
        input = """ 
            "This is a string single quote \' quote"
            """
        expect = """This is a string single quote \' quote,<EOF>"""
        self.assertTrue(TestLexer.test(input, expect, 115))

    # WHICH ERROR ? 
    def test_lexer116(self):
        input = """ 
            "This is a string \\\\ backlash"
            """
        expect = """This is a string \\\\ backlash,<EOF>"""
        self.assertTrue(TestLexer.test(input, expect, 116))

    
    def test_lexer117(self):
        input = """ 
            "This is a string carriage \\"return qqq"
            """
        expect = "This is a string carriage \\\"return qqq,<EOF>"
        self.assertTrue(TestLexer.test(input, expect, 117))


    def test_lexer118(self):
        input = """ 
            "This is a string backspace \\b space"
            """
        expect = "This is a string backspace \\b space,<EOF>"
    ...
    def test_lexer101(self):
        self.assertTrue(TestLexer.test(".12e-10", ".12e-10,<EOF>", 101))
